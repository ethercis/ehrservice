...
import org.openehr.am.xml.adapter.IntervalRealAdapter;
...
@XmlType(
		...
		propOrder = {"magnitude", "precision", "units"}
)
public class CDvQuantityItem implements Serializable{
	private static final long serialVersionUID = -8574661827854370015L;
	/**
	 * Constructor 
	 * 
	 * @param magnitude 
	...
	/* fields */
	@XmlJavaTypeAdapter(IntervalRealAdapter.class)
