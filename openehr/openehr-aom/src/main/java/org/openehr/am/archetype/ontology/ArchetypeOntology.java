...
public class ArchetypeOntology  implements Serializable{
    ...
    public ArchetypeOntology(String primaryLanguage,
        ...
        this(primaryLanguage, null, terminologies, termDefinitionsList, constDefinitionsList, termBindingList, constraintBindingList);
    }

    // 2017-03-22 RVE: this constructor was added while importing changes from openerh-am-rm-term-1.0.9
    public ArchetypeOntology(String primaryLanguage,
    ...
    private void loadDefs(Map<String, Map<String, ArchetypeTerm>> map,
        ...
        for (OntologyDefinitions defs : list) {
            ...
            if(!this.supportedLanguages.contains(defs.getLanguage())) {
                this.supportedLanguages.add(defs.getLanguage());
            }
