...
public final class Interval<T extends Comparable> extends RMObject {
    ...
    private void adjustValues() {
        if(this.lower != null && this.upper != null && this.upper.compareTo(this.lower) < 0) {
            throw new IllegalArgumentException("lower > upper");
        } else {
            this.lowerIncluded = this.lower == null?false:this.lowerIncluded;
            this.upperIncluded = this.upper == null?false:this.upperIncluded;
        }
    }
