...
import com.ethercis.opt.mapper.Interval;
...
public class OptVisitor extends RmBinding {
    ...
    public OptVisitor() throws Exception {
        super(null);
    }

    protected OptVisitor(Map<SystemValue, Object> map) throws Exception {
        super(map);
    }

    private Map traversePrimitiveTypeObject(CPRIMITIVEOBJECT cpo) throws Exception {
