...
public class Time {
    ...
    static final String type = "DV_TIME";

    CCOMPLEXOBJECT ccomplexobject;
    Map<String, TermDefinition> termDef;

    public Time(CCOMPLEXOBJECT ccomplexobject, Map<String, TermDefinition> termDef) {
