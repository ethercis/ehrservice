...
//        I_ContentBuilder contentBuilder = I_ContentBuilder.getInstance(I_ContentBuilder.OPT, knowledge, "action test");
        ...
        TestCase.assertNotNull(stringMap);
    }
...
//        I_ContentBuilder contentBuilder = I_ContentBuilder.getInstance(I_ContentBuilder.OPT, knowledge, "action test");
        ...
        TestCase.assertNotNull(exportXml);
...
//    @Test
    public void _testSetEvaluationEntry() throws Exception {
        ...
        TestCase.assertNotNull(newComposition);
    }
...
//        StringReader reader = new StringReader(new String(exportXml));
            ...
            TestCase.assertNotNull(importedComposition);
...
//        map.put("ctx/id_scheme", "HOSPITAL-NS");
        ...
        TestCase.assertNotNull(lastComposition);
...
//        FileReader fileReader = new FileReader(resourcePath+"/samples/ticket_37.flat.json");
        ...
        TestCase.assertNotNull(stringified);
