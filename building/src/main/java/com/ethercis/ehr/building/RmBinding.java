...
public abstract class RmBinding implements I_RmBinding {
    ...
    protected RmBinding(Map<SystemValue, Object> map) throws Exception {
        if (map != null) {
            ...
            systemValues.put(SystemValue.LANGUAGE, parameters.get(SystemValue.LANGUAGE, makeCodePhrase(DEFAULT_LANGUAGE)));
            systemValues.put(SystemValue.ENCODING, parameters.get(SystemValue.ENCODING, makeCodePhrase(DEFAULT_ENCODING)));
            systemValues.put(SystemValue.CHARSET, parameters.get(SystemValue.CHARSET, makeCodePhrase(DEFAULT_CHARSET)));
            systemValues.put(SystemValue.COMPOSER, parameters.get(SystemValue.COMPOSER, makePartyIdentified(DEFAULT_COMPOSER)));
            systemValues.put(SystemValue.TERRITORY, parameters.get(SystemValue.TERRITORY, makeCodePhrase(DEFAULT_TERRITORY)));
            systemValues.put(SystemValue.CATEGORY, parameters.get(SystemValue.CATEGORY, makeDefaultCodedText(DEFAULT_CATEGORY))); //care entry
            ...
            systemValues.put(SystemValue.CONTEXT, parameters.get(SystemValue.CONTEXT, makeDefaultEventContext()));
            ...
            systemValues.put(SystemValue.LANGUAGE, makeCodePhrase(DEFAULT_LANGUAGE));
            systemValues.put(SystemValue.ENCODING, makeCodePhrase(DEFAULT_ENCODING));
            systemValues.put(SystemValue.CHARSET, makeCodePhrase(DEFAULT_CHARSET));
            systemValues.put(SystemValue.TERRITORY, makeCodePhrase(DEFAULT_TERRITORY));
    ...
    protected void setCompositionValues(Map<String, Object> map){
        ...
        if (!map.containsKey(SystemValue.TERRITORY.id()) && systemValues.containsKey(SystemValue.TERRITORY))
            ...
            map.put(SystemValue.TERRITORY.id(), makeCodePhrase(DEFAULT_TERRITORY));
        ...
        if (!map.containsKey(SystemValue.LANGUAGE.id()) && systemValues.containsKey(SystemValue.LANGUAGE))
            ...
            map.put(SystemValue.LANGUAGE.id(), makeCodePhrase(DEFAULT_LANGUAGE));
