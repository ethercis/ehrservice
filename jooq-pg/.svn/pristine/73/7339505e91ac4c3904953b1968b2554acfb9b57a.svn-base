...
public class StatusRecord extends UpdatableRecordImpl<StatusRecord> implements Record8<UUID, UUID, Boolean, Boolean, UUID, Object, Timestamp, Object> {

	private static final long serialVersionUID = -1888138823;
	 ...
	 */
	@Override
	public StatusRecord value6(Object value) {
	 ...
	 */
	@Override
	public StatusRecord value8(Object value) {
		setSysPeriod(value);
		return this;
	}
	 ...
	 */
	@Override
	public StatusRecord values(UUID value1, UUID value2, Boolean value3, Boolean value4, UUID value5, Object value6, Timestamp value7, Object value8) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public StatusRecord(UUID id, UUID ehrId, Boolean isQueryable, Boolean isModifiable, UUID party, Object otherDetails, Timestamp sysTransaction, Object sysPeriod) {
		super(Status.STATUS);
