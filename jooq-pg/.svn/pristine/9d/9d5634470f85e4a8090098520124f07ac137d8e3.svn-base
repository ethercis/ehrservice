...
public class EventContextRecord extends UpdatableRecordImpl<EventContextRecord> implements Record12<UUID, UUID, Timestamp, String, Timestamp, String, UUID, String, Object, UUID, Timestamp, Object> {

	private static final long serialVersionUID = 1246459776;
	 ...
	 */
	@Override
	public EventContextRecord value9(Object value) {
	 ...
	 */
	@Override
	public EventContextRecord value10(UUID value) {
		setSetting(value);
		return this;
	}
	 ...
	 */
	@Override
	public EventContextRecord value12(Object value) {
		setSysPeriod(value);
		return this;
	}
	 ...
	 */
	@Override
	public EventContextRecord values(UUID value1, UUID value2, Timestamp value3, String value4, Timestamp value5, String value6, UUID value7, String value8, Object value9, UUID value10, Timestamp value11, Object value12) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public EventContextRecord(UUID id, UUID compositionId, Timestamp startTime, String startTimeTzid, Timestamp endTime, String endTimeTzid, UUID facility, String location, Object otherContext, UUID setting, Timestamp sysTransaction, Object sysPeriod) {
		super(EventContext.EVENT_CONTEXT);
