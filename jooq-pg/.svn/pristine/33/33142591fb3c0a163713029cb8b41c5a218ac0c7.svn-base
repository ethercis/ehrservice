...
public class EntryHistory extends TableImpl<EntryHistoryRecord> {
	...
	private static final long serialVersionUID = -1157376068;
	 ...
	 */
	public final TableField<EntryHistoryRecord, EntryType> ITEM_TYPE = createField("item_type", org.jooq.util.postgres.PostgresDataType.VARCHAR.asEnumDataType(com.ethercis.jooq.pg.enums.EntryType.class), this, "");
