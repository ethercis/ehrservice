...
public class Language extends TableImpl<LanguageRecord> {
	...
	private static final long serialVersionUID = -339257278;
	 ...
	 */
	public final TableField<LanguageRecord, String> CODE = createField("code", org.jooq.impl.SQLDataType.VARCHAR.length(5).nullable(false), this, "");

	/**
	 * The column <code>ehr.language.description</code>.
	 */
	public final TableField<LanguageRecord, String> DESCRIPTION = createField("description", org.jooq.impl.SQLDataType.VARCHAR.length(100).nullable(false), this, "");
	...
	private Language(String alias, Table<LanguageRecord> aliased, Field<?>[] parameters) {
		super(alias, Ehr.EHR, aliased, parameters, "ISO 639-1 language codeset");
	}
