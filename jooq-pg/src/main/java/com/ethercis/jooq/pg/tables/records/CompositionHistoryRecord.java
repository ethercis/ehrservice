...
public class CompositionHistoryRecord extends TableRecordImpl<CompositionHistoryRecord> implements Record10<UUID, UUID, UUID, Boolean, Boolean, String, Integer, UUID, Timestamp, Object> {

	private static final long serialVersionUID = 1132892752;
	 ...
	 */
	@Override
	public Row10<UUID, UUID, UUID, Boolean, Boolean, String, Integer, UUID, Timestamp, Object> fieldsRow() {
	 ...
	 */
	@Override
	public Row10<UUID, UUID, UUID, Boolean, Boolean, String, Integer, UUID, Timestamp, Object> valuesRow() {
	 ...
	 */
	@Override
	public CompositionHistoryRecord value10(Object value) {
		setSysPeriod(value);
		return this;
	}
	 ...
	 */
	@Override
	public CompositionHistoryRecord values(UUID value1, UUID value2, UUID value3, Boolean value4, Boolean value5, String value6, Integer value7, UUID value8, Timestamp value9, Object value10) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public CompositionHistoryRecord(UUID id, UUID ehrId, UUID inContribution, Boolean active, Boolean isPersistent, String language, Integer territory, UUID composer, Timestamp sysTransaction, Object sysPeriod) {
		super(CompositionHistory.COMPOSITION_HISTORY);
