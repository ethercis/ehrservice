 ...
 */
public interface I_CanonicalHandler {
    Composition build(String content) throws Exception;

    UUID storeComposition(UUID ehrId, String xmlContent, UUID committerId, UUID systemId, String description) throws Exception;
