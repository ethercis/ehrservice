...
//        compositionAccess.setCommitted(true);
    ...
    public static I_CompositionAccess retrieveInstance2(I_DomainAccess domainAccess, UUID id) throws Exception {
        ...
        selectQuery.addJoin(feederAuditRef, JoinType.LEFT_OUTER_JOIN, feederAuditRef.field(FEEDER_AUDIT.COMPOSITION_ID.getName(), UUID.class).eq(ENTRY.COMPOSITION_ID));
