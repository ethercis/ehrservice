...
public interface I_PartyIdentifiedAccess extends I_SimpleCRUD<I_PartyIdentifiedAccess, UUID> {
    ...
    /**
     * retrieve or create a party with a list of identifiers
     * @param domainAccess
     * @param name
     * @param identifierList list of DvIdentifier
     * @return
     */
    static UUID getOrCreateParty(I_DomainAccess domainAccess, String name, List<DvIdentifier> identifierList){
