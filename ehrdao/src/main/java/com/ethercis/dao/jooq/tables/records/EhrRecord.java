...
public class EhrRecord extends org.jooq.impl.UpdatableRecordImpl<com.ethercis.dao.jooq.tables.records.EhrRecord> implements org.jooq.Record6<java.util.UUID, java.sql.Timestamp, java.lang.String, java.util.UUID, java.util.UUID, java.util.UUID> {

	private static final long serialVersionUID = 1594803913;
	 ...
	 */
	public void setDateCreatedTzid(java.lang.String value) {
		setValue(2, value);
	}
	 ...
	 */
	public java.lang.String getDateCreatedTzid() {
	 ...
	 */
	@Override
	public org.jooq.Row6<java.util.UUID, java.sql.Timestamp, java.lang.String, java.util.UUID, java.util.UUID, java.util.UUID> fieldsRow() {
	 ...
	 */
	@Override
	public org.jooq.Row6<java.util.UUID, java.sql.Timestamp, java.lang.String, java.util.UUID, java.util.UUID, java.util.UUID> valuesRow() {
	...
	public org.jooq.Field<java.lang.String> field3() {
		return com.ethercis.dao.jooq.tables.Ehr.EHR.DATE_CREATED_TZID;
	}
	 ...
	 */
	@Override
	public EhrRecord value3(java.lang.String value) {
	 ...
	 */
	@Override
	public EhrRecord value6(java.util.UUID value) {
		setDirectory(value);
		return this;
	}
	 ...
	 */
	@Override
	public EhrRecord values(java.util.UUID value1, java.sql.Timestamp value2, java.lang.String value3, java.util.UUID value4, java.util.UUID value5, java.util.UUID value6) {
		return this;
	}
	 ...
	 */
	public EhrRecord(java.util.UUID id, java.sql.Timestamp dateCreated, java.lang.String dateCreatedTzid, java.util.UUID access, java.util.UUID systemId, java.util.UUID directory) {
		super(com.ethercis.dao.jooq.tables.Ehr.EHR);

		setValue(0, id);
		setValue(1, dateCreated);
		setValue(2, dateCreatedTzid);
		setValue(3, access);
		setValue(4, systemId);
		setValue(5, directory);
	}
}
