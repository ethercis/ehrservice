...
public class PvCompoHandler extends PathValue {
    ...
    public UUID storeComposition(UUID ehrId, Map<String, String> keyValues) throws Exception {
        ...
        return compositionAccess.commit();
    }

    public Boolean updateComposition(Map<String, String> keyValues) throws Exception {
...
//        EventContext eventContext = contextAccess.mapRmEventContext();
       ...
       if (updateCompositionAttributes(keyValues))
        ...
        if (changed)
            return compositionAccess.update(updateTransactionTime);
