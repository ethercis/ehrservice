...
public interface I_CompositionAccess extends I_SimpleCRUD<I_CompositionAccess, UUID> {
     ...
     */
    public static I_CompositionAccess getNewInstance(I_DomainAccess domain, String languageCode, String territoryCode, DateTime dateCreated, UUID eventContextId, UUID composerId, UUID ehrId) throws EhrException {
     ...
     * @throws EhrException if creation failed
     */
    public static I_CompositionAccess getNewInstance(I_DomainAccess domain, Composition composition, DateTime dateCreated, UUID ehrId) throws Exception {
     ...
     */
    public static I_CompositionAccess getInstance(I_DomainAccess domainAccess, CompositionRecord compositionRecord) {
     ...
     */
    public static Map<UUID, I_CompositionAccess> retrieveInstancesInContributionVersion(I_DomainAccess domainAccess, UUID contributionVersionId, Integer versionNumber){
...
//    void createComposition(UUID ehrId, UUID composerId, UUID contextId, UUID contributionId, String languageCode, String territoryCode, DateTime created) throws EhrException;
     ...
     */
    public List<I_EntryAccess> getContent() throws EhrException;
     ...
     */
    public void setContributionId(UUID contributionVersionId);
