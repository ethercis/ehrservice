...
//	private Gson gson = new Gson();
	...
	static final String TAG_ACTIVITIES="/activities";
...
//			throw new Exception("duplicate key:"+key+", please fix the input structure");
     ...
     * @throws Exception
     */
	private void encodeNodeAttribute(Map<String, Object> map, String tag, DataValue value, String name) throws Exception {
...
//            putObject(valuemap, TAG_PATH, elementStack.pathStackDump()+tag);
//        }

//        putObject(map, getNodeTag(tag, null), valuemap);
//        putObject(map, TAG_VALUE, valuemap);
	...
	private Map<String, Object> mapRmObjectAttributes(RMObject object, String name) throws Exception {
		Map<String, Object> valuemap = newPathMap();
//		VBeanUtil.setValueMap(valuemap, value);
//        valuemap.put(TAG_VALUE, value);
...
//
//            putObject(valuemap, TAG_VALUE, valuemap);
