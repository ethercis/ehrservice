 ...
 */
public class DvProportionSerializer extends DvTypeSerializer<DvProportion> {

	public DvProportionSerializer(AdapterType adapterType) {
		super(adapterType);
	}

	public DvProportionSerializer() {
	}
