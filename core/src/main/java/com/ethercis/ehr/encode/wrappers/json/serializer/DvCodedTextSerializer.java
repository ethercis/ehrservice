 ...
 */
public class DvCodedTextSerializer extends DvTypeSerializer<DvCodedText> {

	private Gson gson;

	public DvCodedTextSerializer(AdapterType adapterType) {
		super(adapterType);
