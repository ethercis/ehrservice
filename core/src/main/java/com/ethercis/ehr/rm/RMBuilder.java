 ...
 */
package com.ethercis.ehr.rm;

import com.ethercis.ehr.encode.wrappers.I_VBeanWrapper;
import org.apache.commons.lang.ClassUtils;
import org.apache.commons.lang.StringUtils;
import org.openehr.build.AttributeFormatException;
import org.openehr.build.AttributeMissingException;
...
public class RMBuilder {
	...
	public static RMBuilder getInstance(Map<SystemValue, Object> systemValues) {
		return new RMBuilder(systemValues);
	}

	public static RMBuilder getInstance() {
		return defaultInstance;
	}

	public RMBuilder(Map<SystemValue, Object> systemValues) {
...
//		}
	...
	protected static final RMBuilder defaultInstance = new RMBuilder();
